...
public class Hooks {
	...
	public void initialization(Scenario sc) {
		try {
			...
			int tcid = db.sqlSelectTestID("select ID from VelocityTestAutomation.dbo.test_case where AzureStoryID = '" + scenarioName + "' AND AzureTestID = '" + testName + "' AND RunMode = 'Y';");
